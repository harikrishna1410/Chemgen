...
write_coef_module(os.path.dirname(abs_path), chem,parallel_level=4,nreact_per_block=4)
write_constants_header(os.path.dirname(abs_path), chem,parallel_level=4,veclen=16,nreact_per_block=4)
