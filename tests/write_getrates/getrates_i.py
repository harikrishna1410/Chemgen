...
def getrates(veclen, T, Y, P, wdot):
    ...
    for i in range(veclen):
        if P[i] < 1.332423750000000e+04:
            kfl=2.100000000000000e+05 * (T[i] ** (1.9)) * np.exp(1.064000000000000e+03 / (Rc * T[i]))
            kfh=2.100000000000000e+05 * (T[i] ** (1.9)) * np.exp(1.064000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.497340024132191e+00
        elif P[i] < 1.332423750000000e+06:
            kfl=2.500000000000000e+05 * (T[i] ** (1.88)) * np.exp(1.043000000000000e+03 / (Rc * T[i]))
            kfh=8.700000000000000e+05 * (T[i] ** (1.73)) * np.exp(6.850000000000000e+02 / (Rc * T[i]))
            logPl=1.179992511712624e+01
            logPh=1.410251021012028e+01
        elif P[i] < 1.333234349999999e+07:
            kfl=8.700000000000000e+05 * (T[i] ** (1.73)) * np.exp(6.850000000000000e+02 / (Rc * T[i]))
            kfh=6.800000000000000e+06 * (T[i] ** (1.48)) * np.exp(-4.800000000000000e+01 / (Rc * T[i]))
            logPl=1.410251021012028e+01
            logPh=1.640570348315436e+01
        elif P[i] < 1.333234350000001e+08:
            kfl=6.800000000000000e+06 * (T[i] ** (1.48)) * np.exp(-4.800000000000000e+01 / (Rc * T[i]))
            kfh=2.300000000000000e+07 * (T[i] ** (1.35)) * np.exp(-9.740000000000000e+02 / (Rc * T[i]))
            logPl=1.640570348315436e+01
            logPh=1.870828857614841e+01
        else:
            kfl=2.300000000000000e+07 * (T[i] ** (1.35)) * np.exp(-9.740000000000000e+02 / (Rc * T[i]))
            kfh=2.300000000000000e+07 * (T[i] ** (1.35)) * np.exp(-9.740000000000000e+02 / (Rc * T[i]))
            logPl=1.870828857614841e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=4.936000000000000e+14 * (T[i] ** (-0.669)) * np.exp(4.458000000000000e+02 / (Rc * T[i]))
            kfh=4.936000000000000e+14 * (T[i] ** (-0.669)) * np.exp(4.458000000000000e+02 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000000e+06:
            kfl=1.207000000000000e+15 * (T[i] ** (-0.778)) * np.exp(1.756000000000000e+02 / (Rc * T[i]))
            kfh=5.282000000000000e+17 * (T[i] ** (-1.518)) * np.exp(-1.772000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=5.282000000000000e+17 * (T[i] ** (-1.518)) * np.exp(-1.772000000000000e+03 / (Rc * T[i]))
            kfh=4.788000000000000e+23 * (T[i] ** (-3.155)) * np.exp(-7.003000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=4.788000000000000e+23 * (T[i] ** (-3.155)) * np.exp(-7.003000000000000e+03 / (Rc * T[i]))
            kfh=8.433000000000000e+19 * (T[i] ** (-1.962)) * np.exp(-8.244000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=8.433000000000000e+19 * (T[i] ** (-1.962)) * np.exp(-8.244000000000000e+03 / (Rc * T[i]))
            kfh=8.433000000000000e+19 * (T[i] ** (-1.962)) * np.exp(-8.244000000000000e+03 / (Rc * T[i]))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=3.502000000000000e+05 * (T[i] ** (1.441)) * np.exp(3.244000000000000e+03 / (Rc * T[i]))
            kfh=3.502000000000000e+05 * (T[i] ** (1.441)) * np.exp(3.244000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000000e+06:
            kfl=8.854000000000001e+05 * (T[i] ** (1.327)) * np.exp(2.975000000000000e+03 / (Rc * T[i]))
            kfh=1.650000000000000e+07 * (T[i] ** (0.973)) * np.exp(2.010000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.650000000000000e+07 * (T[i] ** (0.973)) * np.exp(2.010000000000000e+03 / (Rc * T[i]))
            kfh=5.374000000000000e+09 * (T[i] ** (0.287)) * np.exp(-2.800000000000000e+02 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=5.374000000000000e+09 * (T[i] ** (0.287)) * np.exp(-2.800000000000000e+02 / (Rc * T[i]))
            kfh=9.494000000000000e+18 * (T[i] ** (-2.199)) * np.exp(-9.769000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=9.494000000000000e+18 * (T[i] ** (-2.199)) * np.exp(-9.769000000000000e+03 / (Rc * T[i]))
            kfh=9.494000000000000e+18 * (T[i] ** (-2.199)) * np.exp(-9.769000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=1.053650000000000e+10 * (T[i] ** (0.965)) * np.exp(-3.210000000000000e+03 / (Rc * T[i]))
            kfh=1.053650000000000e+10 * (T[i] ** (0.965)) * np.exp(-3.210000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000000e+06:
            kfl=1.174550000000000e+10 * (T[i] ** (0.95)) * np.exp(-3.250000000000000e+03 / (Rc * T[i]))
            kfh=3.045900000000000e+10 * (T[i] ** (0.833)) * np.exp(-3.570000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=3.045900000000000e+10 * (T[i] ** (0.833)) * np.exp(-3.570000000000000e+03 / (Rc * T[i]))
            kfh=9.912500000000000e+12 * (T[i] ** (0.134)) * np.exp(-5.640000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=9.912500000000000e+12 * (T[i] ** (0.134)) * np.exp(-5.640000000000000e+03 / (Rc * T[i]))
            kfh=2.333500000000000e+14 * (T[i] ** (-0.186)) * np.exp(-8.600000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=2.333500000000000e+14 * (T[i] ** (-0.186)) * np.exp(-8.600000000000000e+03 / (Rc * T[i]))
            kfh=2.333500000000000e+14 * (T[i] ** (-0.186)) * np.exp(-8.600000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=1.186000000000000e+09 * (T[i] ** (1.016)) * np.exp(-1.194000000000000e+04 / (Rc * T[i]))
            kfh=1.186000000000000e+09 * (T[i] ** (1.016)) * np.exp(-1.194000000000000e+04 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000000e+06:
            kfl=1.188000000000000e+09 * (T[i] ** (1.016)) * np.exp(-1.194000000000000e+04 / (Rc * T[i]))
            kfh=1.230000000000000e+09 * (T[i] ** (1.011)) * np.exp(-1.195000000000000e+04 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.230000000000000e+09 * (T[i] ** (1.011)) * np.exp(-1.195000000000000e+04 / (Rc * T[i]))
            kfh=1.798000000000000e+09 * (T[i] ** (0.965)) * np.exp(-1.206000000000000e+04 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=1.798000000000000e+09 * (T[i] ** (0.965)) * np.exp(-1.206000000000000e+04 / (Rc * T[i]))
            kfh=5.242000000000000e+10 * (T[i] ** (0.551)) * np.exp(-1.307000000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=5.242000000000000e+10 * (T[i] ** (0.551)) * np.exp(-1.307000000000000e+04 / (Rc * T[i]))
            kfh=5.242000000000000e+10 * (T[i] ** (0.551)) * np.exp(-1.307000000000000e+04 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=8.674000000000000e+08 * (T[i] ** (0.787)) * np.exp(3.046000000000000e+03 / (Rc * T[i]))
            kfh=8.674000000000000e+08 * (T[i] ** (0.787)) * np.exp(3.046000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000000e+06:
            kfl=3.115000000000000e+09 * (T[i] ** (0.63)) * np.exp(2.669000000000000e+03 / (Rc * T[i]))
            kfh=1.557000000000000e+11 * (T[i] ** (0.156)) * np.exp(1.368000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.557000000000000e+11 * (T[i] ** (0.156)) * np.exp(1.368000000000000e+03 / (Rc * T[i]))
            kfh=1.704000000000000e+21 * (T[i] ** (-2.641)) * np.exp(-6.412000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=1.704000000000000e+21 * (T[i] ** (-2.641)) * np.exp(-6.412000000000000e+03 / (Rc * T[i]))
            kfh=7.250000000000000e+20 * (T[i] ** (-2.402)) * np.exp(-9.639000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=7.250000000000000e+20 * (T[i] ** (-2.402)) * np.exp(-9.639000000000000e+03 / (Rc * T[i]))
            kfh=7.250000000000000e+20 * (T[i] ** (-2.402)) * np.exp(-9.639000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=4.740000000000000e+12 * (T[i] ** (0.105)) * np.exp(-1.066430000000000e+04 / (Rc * T[i]))
            kfh=4.740000000000000e+12 * (T[i] ** (0.105)) * np.exp(-1.066430000000000e+04 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000000e+06:
            kfl=2.570000000000000e+13 * (T[i] ** (-0.096)) * np.exp(-1.140610000000000e+04 / (Rc * T[i]))
            kfh=3.100000000000000e+14 * (T[i] ** (-0.362)) * np.exp(-1.337250000000000e+04 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=3.100000000000000e+14 * (T[i] ** (-0.362)) * np.exp(-1.337250000000000e+04 / (Rc * T[i]))
            kfh=2.150000000000000e+10 * (T[i] ** (0.885)) * np.exp(-1.353250000000000e+04 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=2.150000000000000e+10 * (T[i] ** (0.885)) * np.exp(-1.353250000000000e+04 / (Rc * T[i]))
            kfh=1.032000000000000e+02 * (T[i] ** (3.23)) * np.exp(-1.123610000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=1.032000000000000e+02 * (T[i] ** (3.23)) * np.exp(-1.123610000000000e+04 / (Rc * T[i]))
            kfh=1.032000000000000e+02 * (T[i] ** (3.23)) * np.exp(-1.123610000000000e+04 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+03:
            kfl=1.292600000000000e+19 * (T[i] ** (-1.96)) * np.exp(-2.727000000000000e+02 / (Rc * T[i]))
            kfh=1.292600000000000e+19 * (T[i] ** (-1.96)) * np.exp(-2.727000000000000e+02 / (Rc * T[i]))
            logPl=1.0e0
            logPh=6.920918265508418e+00
        elif P[i] < 1.013250000000001e+05:
            kfl=1.218400000000000e+19 * (T[i] ** (-1.9533)) * np.exp(-2.388000000000000e+02 / (Rc * T[i]))
            kfh=4.105200000000000e+19 * (T[i] ** (-2.1007)) * np.exp(-6.254000000000000e+02 / (Rc * T[i]))
            logPl=9.223503358502464e+00
            logPh=1.152608845149651e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=4.105200000000000e+19 * (T[i] ** (-2.1007)) * np.exp(-6.254000000000000e+02 / (Rc * T[i]))
            kfh=7.940600000000000e+22 * (T[i] ** (-2.9892)) * np.exp(-3.862600000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=7.940600000000000e+22 * (T[i] ** (-2.9892)) * np.exp(-3.862600000000000e+03 / (Rc * T[i]))
            kfh=2.792600000000000e+24 * (T[i] ** (-3.3287)) * np.exp(-7.748799999999999e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=2.792600000000000e+24 * (T[i] ** (-3.3287)) * np.exp(-7.748799999999999e+03 / (Rc * T[i]))
            kfh=4.696100000000000e+18 * (T[i] ** (-1.5805)) * np.exp(-7.999200000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=4.696100000000000e+18 * (T[i] ** (-1.5805)) * np.exp(-7.999200000000000e+03 / (Rc * T[i]))
            kfh=4.696100000000000e+18 * (T[i] ** (-1.5805)) * np.exp(-7.999200000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+03:
            kfl=9.201700000000000e+17 * (T[i] ** (-1.2994)) * np.exp(-2.504600000000000e+03 / (Rc * T[i]))
            kfh=9.201700000000000e+17 * (T[i] ** (-1.2994)) * np.exp(-2.504600000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=6.920918265508418e+00
        elif P[i] < 1.013250000000001e+05:
            kfl=1.098100000000000e+18 * (T[i] ** (-1.3206)) * np.exp(-2.569400000000000e+03 / (Rc * T[i]))
            kfh=5.736700000000000e+18 * (T[i] ** (-1.5182)) * np.exp(-3.184800000000000e+03 / (Rc * T[i]))
            logPl=9.223503358502464e+00
            logPh=1.152608845149651e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=5.736700000000000e+18 * (T[i] ** (-1.5182)) * np.exp(-3.184800000000000e+03 / (Rc * T[i]))
            kfh=6.527800000000000e+21 * (T[i] ** (-2.3515)) * np.exp(-6.022700000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=6.527800000000000e+21 * (T[i] ** (-2.3515)) * np.exp(-6.022700000000000e+03 / (Rc * T[i]))
            kfh=1.879900000000000e+25 * (T[i] ** (-3.2495)) * np.exp(-1.057620000000000e+04 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=1.879900000000000e+25 * (T[i] ** (-3.2495)) * np.exp(-1.057620000000000e+04 / (Rc * T[i]))
            kfh=6.504400000000001e+22 * (T[i] ** (-2.4427)) * np.exp(-1.264660000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=6.504400000000001e+22 * (T[i] ** (-2.4427)) * np.exp(-1.264660000000000e+04 / (Rc * T[i]))
            kfh=6.504400000000001e+22 * (T[i] ** (-2.4427)) * np.exp(-1.264660000000000e+04 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+02:
            kfl=9.100000000000000e+00 * (T[i] ** (2.87)) * np.exp(5.099000000000000e+03 / (Rc * T[i]))
            kfh=9.100000000000000e+00 * (T[i] ** (2.87)) * np.exp(5.099000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=4.618333172514372e+00
        elif P[i] < 1.013250000000000e+03:
            kfl=1.180000000000000e+01 * (T[i] ** (2.84)) * np.exp(5.029000000000000e+03 / (Rc * T[i]))
            kfh=2.820000000000000e+01 * (T[i] ** (2.73)) * np.exp(4.780000000000000e+03 / (Rc * T[i]))
            logPl=5.716945461182481e+00
            logPh=6.920918265508418e+00
        elif P[i] < 3.039750000000001e+03:
            kfl=2.820000000000000e+01 * (T[i] ** (2.73)) * np.exp(4.780000000000000e+03 / (Rc * T[i]))
            kfh=1.100000000000000e+02 * (T[i] ** (2.56)) * np.exp(4.380000000000000e+03 / (Rc * T[i]))
            logPl=6.920918265508418e+00
            logPh=8.019530554176528e+00
        elif P[i] < 1.013250000000000e+04:
            kfl=1.100000000000000e+02 * (T[i] ** (2.56)) * np.exp(4.380000000000000e+03 / (Rc * T[i]))
            kfh=9.570000000000001e+02 * (T[i] ** (2.3)) * np.exp(3.735000000000000e+03 / (Rc * T[i]))
            logPl=8.019530554176528e+00
            logPh=9.223503358502464e+00
        elif P[i] < 3.039750000000002e+04:
            kfl=9.570000000000001e+02 * (T[i] ** (2.3)) * np.exp(3.735000000000000e+03 / (Rc * T[i]))
            kfh=1.320000000000000e+04 * (T[i] ** (1.98)) * np.exp(2.933000000000000e+03 / (Rc * T[i]))
            logPl=9.223503358502464e+00
            logPh=1.032211564717057e+01
        elif P[i] < 1.013250000000001e+05:
            kfl=1.320000000000000e+04 * (T[i] ** (1.98)) * np.exp(2.933000000000000e+03 / (Rc * T[i]))
            kfh=4.900000000000001e+05 * (T[i] ** (1.54)) * np.exp(1.790000000000000e+03 / (Rc * T[i]))
            logPl=1.032211564717057e+01
            logPh=1.152608845149651e+01
        elif P[i] < 3.039750000000000e+05:
            kfl=4.900000000000001e+05 * (T[i] ** (1.54)) * np.exp(1.790000000000000e+03 / (Rc * T[i]))
            kfh=2.410000000000000e+07 * (T[i] ** (1.07)) * np.exp(4.977000000000000e+02 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.262470074016462e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=2.410000000000000e+07 * (T[i] ** (1.07)) * np.exp(4.977000000000000e+02 / (Rc * T[i]))
            kfh=2.470000000000000e+09 * (T[i] ** (0.51)) * np.exp(-1.157000000000000e+03 / (Rc * T[i]))
            logPl=1.262470074016462e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.039749999999998e+06:
            kfl=2.470000000000000e+09 * (T[i] ** (0.51)) * np.exp(-1.157000000000000e+03 / (Rc * T[i]))
            kfh=1.360000000000000e+11 * (T[i] ** (0.04)) * np.exp(-2.789000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.492728583315866e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.360000000000000e+11 * (T[i] ** (0.04)) * np.exp(-2.789000000000000e+03 / (Rc * T[i]))
            kfh=3.130000000000000e+12 * (T[i] ** (-0.31)) * np.exp(-4.501000000000000e+03 / (Rc * T[i]))
            logPl=1.492728583315866e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.039750000000001e+07:
            kfl=3.130000000000000e+12 * (T[i] ** (-0.31)) * np.exp(-4.501000000000000e+03 / (Rc * T[i]))
            kfh=5.290000000000000e+12 * (T[i] ** (-0.33)) * np.exp(-5.728000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.722987092615271e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=5.290000000000000e+12 * (T[i] ** (-0.33)) * np.exp(-5.728000000000000e+03 / (Rc * T[i]))
            kfh=1.890000000000000e+11 * (T[i] ** (0.14)) * np.exp(-6.373000000000000e+03 / (Rc * T[i]))
            logPl=1.722987092615271e+01
            logPh=1.843384373047865e+01
        else:
            kfl=1.890000000000000e+11 * (T[i] ** (0.14)) * np.exp(-6.373000000000000e+03 / (Rc * T[i]))
            kfh=1.890000000000000e+11 * (T[i] ** (0.14)) * np.exp(-6.373000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+03:
            kfl=1.193500000000000e+26 * (T[i] ** (-5.021)) * np.exp(-3.089757000000000e+03 / (Rc * T[i]))
            kfh=1.193500000000000e+26 * (T[i] ** (-5.021)) * np.exp(-3.089757000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=6.920918265508418e+00
        elif P[i] < 1.013250000000001e+05:
            kfl=1.053500000000000e+27 * (T[i] ** (-5.0)) * np.exp(-3.073364000000000e+03 / (Rc * T[i]))
            kfh=2.107000000000000e+28 * (T[i] ** (-5.085)) * np.exp(-3.485772000000000e+03 / (Rc * T[i]))
            logPl=9.223503358502464e+00
            logPh=1.152608845149651e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=2.107000000000000e+28 * (T[i] ** (-5.085)) * np.exp(-3.485772000000000e+03 / (Rc * T[i]))
            kfh=8.820000000000001e+29 * (T[i] ** (-5.236)) * np.exp(-5.080164000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=8.820000000000001e+29 * (T[i] ** (-5.236)) * np.exp(-5.080164000000000e+03 / (Rc * T[i]))
            kfh=3.623900000000000e+22 * (T[i] ** (-2.791)) * np.exp(-2.637005000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=3.623900000000000e+22 * (T[i] ** (-2.791)) * np.exp(-2.637005000000000e+03 / (Rc * T[i]))
            kfh=1.249500000000000e+19 * (T[i] ** (-1.592)) * np.exp(-1.961089000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=1.249500000000000e+19 * (T[i] ** (-1.592)) * np.exp(-1.961089000000000e+03 / (Rc * T[i]))
            kfh=1.249500000000000e+19 * (T[i] ** (-1.592)) * np.exp(-1.961089000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=5.350000000000000e+00 * (T[i] ** (2.92)) * np.exp(1.732700000000000e+03 / (Rc * T[i]))
            kfh=5.350000000000000e+00 * (T[i] ** (2.92)) * np.exp(1.732700000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000001e+05:
            kfl=3.190000000000000e+01 * (T[i] ** (2.71)) * np.exp(1.172300000000000e+03 / (Rc * T[i]))
            kfh=5.550000000000000e+02 * (T[i] ** (2.36)) * np.exp(1.808000000000000e+02 / (Rc * T[i]))
            logPl=1.013979409037662e+01
            logPh=1.152608845149651e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=5.550000000000000e+02 * (T[i] ** (2.36)) * np.exp(1.808000000000000e+02 / (Rc * T[i]))
            kfh=1.780000000000000e+05 * (T[i] ** (1.68)) * np.exp(-2.060500000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.780000000000000e+05 * (T[i] ** (1.68)) * np.exp(-2.060500000000000e+03 / (Rc * T[i]))
            kfh=2.370000000000000e+09 * (T[i] ** (0.56)) * np.exp(-6.006700000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=2.370000000000000e+09 * (T[i] ** (0.56)) * np.exp(-6.006700000000000e+03 / (Rc * T[i]))
            kfh=2.760000000000000e+13 * (T[i] ** (-0.5)) * np.exp(-1.145510000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=2.760000000000000e+13 * (T[i] ** (-0.5)) * np.exp(-1.145510000000000e+04 / (Rc * T[i]))
            kfh=2.760000000000000e+13 * (T[i] ** (-0.5)) * np.exp(-1.145510000000000e+04 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=1.080000000000000e+07 * (T[i] ** (1.28)) * np.exp(-3.322000000000000e+03 / (Rc * T[i])) + 4.760000000000000e+01 * (T[i] ** (2.75)) * np.exp(7.964000000000000e+02 / (Rc * T[i]))
            kfh=1.080000000000000e+07 * (T[i] ** (1.28)) * np.exp(-3.322000000000000e+03 / (Rc * T[i])) + 4.760000000000000e+01 * (T[i] ** (2.75)) * np.exp(7.964000000000000e+02 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 3.201869999999998e+05:
            kfl=7.750000000000000e+06 * (T[i] ** (1.33)) * np.exp(-3.216000000000000e+03 / (Rc * T[i])) + 5.160000000000000e+01 * (T[i] ** (2.73)) * np.exp(7.683000000000000e+02 / (Rc * T[i]))
            kfh=1.210000000000000e+07 * (T[i] ** (1.27)) * np.exp(-3.311000000000000e+03 / (Rc * T[i])) + 5.550000000000000e+01 * (T[i] ** (2.73)) * np.exp(6.585000000000000e+02 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.267666047909533e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=1.210000000000000e+07 * (T[i] ** (1.27)) * np.exp(-3.311000000000000e+03 / (Rc * T[i])) + 5.550000000000000e+01 * (T[i] ** (2.73)) * np.exp(6.585000000000000e+02 / (Rc * T[i]))
            kfh=2.150000000000000e+07 * (T[i] ** (1.19)) * np.exp(-3.367000000000000e+03 / (Rc * T[i])) + 4.600000000000000e+01 * (T[i] ** (2.76)) * np.exp(4.928000000000000e+02 / (Rc * T[i]))
            logPl=1.267666047909533e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.201870000000002e+06:
            kfl=2.150000000000000e+07 * (T[i] ** (1.19)) * np.exp(-3.367000000000000e+03 / (Rc * T[i])) + 4.600000000000000e+01 * (T[i] ** (2.76)) * np.exp(4.928000000000000e+02 / (Rc * T[i]))
            kfh=1.130000000000000e+08 * (T[i] ** (1.0)) * np.exp(-3.695000000000000e+03 / (Rc * T[i])) + 3.750000000000000e+00 * (T[i] ** (3.07)) * np.exp(6.010000000000000e+02 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.497924557208938e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.130000000000000e+08 * (T[i] ** (1.0)) * np.exp(-3.695000000000000e+03 / (Rc * T[i])) + 3.750000000000000e+00 * (T[i] ** (3.07)) * np.exp(6.010000000000000e+02 / (Rc * T[i]))
            kfh=1.310000000000000e+11 * (T[i] ** (0.12)) * np.exp(-5.872000000000000e+03 / (Rc * T[i])) + 5.480000000000000e+00 * (T[i] ** (3.07)) * np.exp(-8.569999999999999e+01 / (Rc * T[i]))
            logPl=1.497924557208938e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.201870000000000e+07:
            kfl=1.310000000000000e+11 * (T[i] ** (0.12)) * np.exp(-5.872000000000000e+03 / (Rc * T[i])) + 5.480000000000000e+00 * (T[i] ** (3.07)) * np.exp(-8.569999999999999e+01 / (Rc * T[i]))
            kfh=1.190000000000000e+09 * (T[i] ** (0.82)) * np.exp(-5.617000000000000e+03 / (Rc * T[i])) + 4.470000000000000e+08 * np.exp(-9.550000000000000e+02 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.728183066508342e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=1.190000000000000e+09 * (T[i] ** (0.82)) * np.exp(-5.617000000000000e+03 / (Rc * T[i])) + 4.470000000000000e+08 * np.exp(-9.550000000000000e+02 / (Rc * T[i]))
            kfh=1.060000000000000e+17 * (T[i] ** (-1.45)) * np.exp(-1.223000000000000e+04 / (Rc * T[i])) + 2.020000000000000e+01 * (T[i] ** (2.94)) * np.exp(-1.847000000000000e+03 / (Rc * T[i]))
            logPl=1.728183066508342e+01
            logPh=1.843384373047865e+01
        else:
            kfl=1.060000000000000e+17 * (T[i] ** (-1.45)) * np.exp(-1.223000000000000e+04 / (Rc * T[i])) + 2.020000000000000e+01 * (T[i] ** (2.94)) * np.exp(-1.847000000000000e+03 / (Rc * T[i]))
            kfh=1.060000000000000e+17 * (T[i] ** (-1.45)) * np.exp(-1.223000000000000e+04 / (Rc * T[i])) + 2.020000000000000e+01 * (T[i] ** (2.94)) * np.exp(-1.847000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=8.660000000000000e+02 * (T[i] ** (2.41)) * np.exp(-6.061000000000000e+03 / (Rc * T[i])) + 1.820000000000000e-01 * (T[i] ** (3.12)) * np.exp(-1.331000000000000e+03 / (Rc * T[i]))
            kfh=8.660000000000000e+02 * (T[i] ** (2.41)) * np.exp(-6.061000000000000e+03 / (Rc * T[i])) + 1.820000000000000e-01 * (T[i] ** (3.12)) * np.exp(-1.331000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 3.201869999999998e+05:
            kfl=8.910000000000001e+02 * (T[i] ** (2.41)) * np.exp(-6.078000000000000e+03 / (Rc * T[i])) + 2.070000000000000e-01 * (T[i] ** (3.11)) * np.exp(-1.383000000000000e+03 / (Rc * T[i]))
            kfh=9.430000000000001e+02 * (T[i] ** (2.4)) * np.exp(-6.112000000000000e+03 / (Rc * T[i])) + 2.710000000000001e-01 * (T[i] ** (3.08)) * np.exp(-1.496000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.267666047909533e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=9.430000000000001e+02 * (T[i] ** (2.4)) * np.exp(-6.112000000000000e+03 / (Rc * T[i])) + 2.710000000000001e-01 * (T[i] ** (3.08)) * np.exp(-1.496000000000000e+03 / (Rc * T[i]))
            kfh=1.060000000000000e+03 * (T[i] ** (2.39)) * np.exp(-6.180000000000000e+03 / (Rc * T[i])) + 5.260000000000000e-01 * (T[i] ** (3.01)) * np.exp(-1.777000000000000e+03 / (Rc * T[i]))
            logPl=1.267666047909533e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.201870000000002e+06:
            kfl=1.060000000000000e+03 * (T[i] ** (2.39)) * np.exp(-6.180000000000000e+03 / (Rc * T[i])) + 5.260000000000000e-01 * (T[i] ** (3.01)) * np.exp(-1.777000000000000e+03 / (Rc * T[i]))
            kfh=1.090000000000000e+03 * (T[i] ** (2.38)) * np.exp(-6.179000000000000e+03 / (Rc * T[i])) + 1.370000000000000e+00 * (T[i] ** (2.9)) * np.exp(-2.225000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.497924557208938e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.090000000000000e+03 * (T[i] ** (2.38)) * np.exp(-6.179000000000000e+03 / (Rc * T[i])) + 1.370000000000000e+00 * (T[i] ** (2.9)) * np.exp(-2.225000000000000e+03 / (Rc * T[i]))
            kfh=1.390000000000000e+03 * (T[i] ** (2.36)) * np.exp(-6.074000000000000e+03 / (Rc * T[i])) + 4.190000000000000e-01 * (T[i] ** (2.93)) * np.exp(-2.052000000000000e+03 / (Rc * T[i]))
            logPl=1.497924557208938e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.201870000000000e+07:
            kfl=1.390000000000000e+03 * (T[i] ** (2.36)) * np.exp(-6.074000000000000e+03 / (Rc * T[i])) + 4.190000000000000e-01 * (T[i] ** (2.93)) * np.exp(-2.052000000000000e+03 / (Rc * T[i]))
            kfh=2.490000000000000e+06 * (T[i] ** (1.42)) * np.exp(-8.480000000000000e+03 / (Rc * T[i])) + 1.190000000000000e-04 * (T[i] ** (4.21)) * np.exp(-2.043000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.728183066508342e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=2.490000000000000e+06 * (T[i] ** (1.42)) * np.exp(-8.480000000000000e+03 / (Rc * T[i])) + 1.190000000000000e-04 * (T[i] ** (4.21)) * np.exp(-2.043000000000000e+03 / (Rc * T[i]))
            kfh=1.660000000000000e+10 * (T[i] ** (0.36)) * np.exp(-1.201000000000000e+04 / (Rc * T[i])) + 1.300000000000000e-03 * (T[i] ** (3.97)) * np.exp(-3.414000000000000e+03 / (Rc * T[i]))
            logPl=1.728183066508342e+01
            logPh=1.843384373047865e+01
        else:
            kfl=1.660000000000000e+10 * (T[i] ** (0.36)) * np.exp(-1.201000000000000e+04 / (Rc * T[i])) + 1.300000000000000e-03 * (T[i] ** (3.97)) * np.exp(-3.414000000000000e+03 / (Rc * T[i]))
            kfh=1.660000000000000e+10 * (T[i] ** (0.36)) * np.exp(-1.201000000000000e+04 / (Rc * T[i])) + 1.300000000000000e-03 * (T[i] ** (3.97)) * np.exp(-3.414000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=2.770000000000001e+36 * (T[i] ** (-7.6)) * np.exp(-1.264000000000000e+04 / (Rc * T[i])) + 5.040000000000000e+15 * (T[i] ** (-1.28)) * np.exp(-5.153000000000000e+02 / (Rc * T[i]))
            kfh=2.770000000000001e+36 * (T[i] ** (-7.6)) * np.exp(-1.264000000000000e+04 / (Rc * T[i])) + 5.040000000000000e+15 * (T[i] ** (-1.28)) * np.exp(-5.153000000000000e+02 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 3.201869999999998e+05:
            kfl=2.700000000000000e+36 * (T[i] ** (-7.6)) * np.exp(-1.261000000000000e+04 / (Rc * T[i])) + 5.100000000000000e+15 * (T[i] ** (-1.28)) * np.exp(-5.130000000000000e+02 / (Rc * T[i]))
            kfh=2.170000000000000e+36 * (T[i] ** (-7.57)) * np.exp(-1.249000000000000e+04 / (Rc * T[i])) + 5.340000000000000e+15 * (T[i] ** (-1.29)) * np.exp(-5.205999999999999e+02 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.267666047909533e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=2.170000000000000e+36 * (T[i] ** (-7.57)) * np.exp(-1.249000000000000e+04 / (Rc * T[i])) + 5.340000000000000e+15 * (T[i] ** (-1.29)) * np.exp(-5.205999999999999e+02 / (Rc * T[i]))
            kfh=3.030000000000000e+35 * (T[i] ** (-7.32)) * np.exp(-1.182000000000000e+04 / (Rc * T[i])) + 6.760000000000000e+15 * (T[i] ** (-1.31)) * np.exp(-6.457000000000000e+02 / (Rc * T[i]))
            logPl=1.267666047909533e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.201870000000002e+06:
            kfl=3.030000000000000e+35 * (T[i] ** (-7.32)) * np.exp(-1.182000000000000e+04 / (Rc * T[i])) + 6.760000000000000e+15 * (T[i] ** (-1.31)) * np.exp(-6.457000000000000e+02 / (Rc * T[i]))
            kfh=1.590000000000000e+36 * (T[i] ** (-7.47)) * np.exp(-1.246000000000000e+04 / (Rc * T[i])) + 1.050000000000000e+16 * (T[i] ** (-1.36)) * np.exp(-1.066000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.497924557208938e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.590000000000000e+36 * (T[i] ** (-7.47)) * np.exp(-1.246000000000000e+04 / (Rc * T[i])) + 1.050000000000000e+16 * (T[i] ** (-1.36)) * np.exp(-1.066000000000000e+03 / (Rc * T[i]))
            kfh=5.760000000000001e+35 * (T[i] ** (-7.2)) * np.exp(-1.343000000000000e+04 / (Rc * T[i])) + 2.840000000000000e+15 * (T[i] ** (-1.18)) * np.exp(-1.429000000000000e+03 / (Rc * T[i]))
            logPl=1.497924557208938e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.201870000000000e+07:
            kfl=5.760000000000001e+35 * (T[i] ** (-7.2)) * np.exp(-1.343000000000000e+04 / (Rc * T[i])) + 2.840000000000000e+15 * (T[i] ** (-1.18)) * np.exp(-1.429000000000000e+03 / (Rc * T[i]))
            kfh=3.540000000000000e+20 * (T[i] ** (-2.57)) * np.exp(-5.578000000000000e+03 / (Rc * T[i])) + 1.140000000000000e+69 * (T[i] ** (-19.23)) * np.exp(-1.476000000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.728183066508342e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=3.540000000000000e+20 * (T[i] ** (-2.57)) * np.exp(-5.578000000000000e+03 / (Rc * T[i])) + 1.140000000000000e+69 * (T[i] ** (-19.23)) * np.exp(-1.476000000000000e+04 / (Rc * T[i]))
            kfh=3.030000000000000e+33 * (T[i] ** (-6.28)) * np.exp(-1.600000000000000e+04 / (Rc * T[i])) + 4.680000000000000e+10 * (T[i] ** (0.19)) * np.exp(-8.305999999999999e+02 / (Rc * T[i]))
            logPl=1.728183066508342e+01
            logPh=1.843384373047865e+01
        else:
            kfl=3.030000000000000e+33 * (T[i] ** (-6.28)) * np.exp(-1.600000000000000e+04 / (Rc * T[i])) + 4.680000000000000e+10 * (T[i] ** (0.19)) * np.exp(-8.305999999999999e+02 / (Rc * T[i]))
            kfh=3.030000000000000e+33 * (T[i] ** (-6.28)) * np.exp(-1.600000000000000e+04 / (Rc * T[i])) + 4.680000000000000e+10 * (T[i] ** (0.19)) * np.exp(-8.305999999999999e+02 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=6.470000000000001e+36 * (T[i] ** (-7.6)) * np.exp(-1.264000000000000e+04 / (Rc * T[i])) + 1.180000000000000e+16 * (T[i] ** (-1.28)) * np.exp(-5.153000000000000e+02 / (Rc * T[i]))
            kfh=6.470000000000001e+36 * (T[i] ** (-7.6)) * np.exp(-1.264000000000000e+04 / (Rc * T[i])) + 1.180000000000000e+16 * (T[i] ** (-1.28)) * np.exp(-5.153000000000000e+02 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 3.201869999999998e+05:
            kfl=6.290000000000001e+36 * (T[i] ** (-7.6)) * np.exp(-1.261000000000000e+04 / (Rc * T[i])) + 1.190000000000000e+16 * (T[i] ** (-1.28)) * np.exp(-5.130000000000000e+02 / (Rc * T[i]))
            kfh=5.060000000000000e+36 * (T[i] ** (-7.57)) * np.exp(-1.249000000000000e+04 / (Rc * T[i])) + 1.260000000000000e+16 * (T[i] ** (-1.29)) * np.exp(-5.205999999999999e+02 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.267666047909533e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=5.060000000000000e+36 * (T[i] ** (-7.57)) * np.exp(-1.249000000000000e+04 / (Rc * T[i])) + 1.260000000000000e+16 * (T[i] ** (-1.29)) * np.exp(-5.205999999999999e+02 / (Rc * T[i]))
            kfh=7.070000000000000e+35 * (T[i] ** (-7.32)) * np.exp(-1.182000000000000e+04 / (Rc * T[i])) + 1.580000000000000e+16 * (T[i] ** (-1.31)) * np.exp(-6.457000000000000e+02 / (Rc * T[i]))
            logPl=1.267666047909533e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.201870000000002e+06:
            kfl=7.070000000000000e+35 * (T[i] ** (-7.32)) * np.exp(-1.182000000000000e+04 / (Rc * T[i])) + 1.580000000000000e+16 * (T[i] ** (-1.31)) * np.exp(-6.457000000000000e+02 / (Rc * T[i]))
            kfh=3.720000000000000e+36 * (T[i] ** (-7.47)) * np.exp(-1.246000000000000e+04 / (Rc * T[i])) + 2.440000000000000e+16 * (T[i] ** (-1.36)) * np.exp(-1.066000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.497924557208938e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=3.720000000000000e+36 * (T[i] ** (-7.47)) * np.exp(-1.246000000000000e+04 / (Rc * T[i])) + 2.440000000000000e+16 * (T[i] ** (-1.36)) * np.exp(-1.066000000000000e+03 / (Rc * T[i]))
            kfh=1.340000000000000e+36 * (T[i] ** (-7.2)) * np.exp(-1.343000000000000e+04 / (Rc * T[i])) + 6.640000000000000e+15 * (T[i] ** (-1.18)) * np.exp(-1.429000000000000e+03 / (Rc * T[i]))
            logPl=1.497924557208938e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.201870000000000e+07:
            kfl=1.340000000000000e+36 * (T[i] ** (-7.2)) * np.exp(-1.343000000000000e+04 / (Rc * T[i])) + 6.640000000000000e+15 * (T[i] ** (-1.18)) * np.exp(-1.429000000000000e+03 / (Rc * T[i]))
            kfh=8.260000000000000e+20 * (T[i] ** (-2.57)) * np.exp(-5.578000000000000e+03 / (Rc * T[i])) + 2.660000000000000e+69 * (T[i] ** (-19.23)) * np.exp(-1.476000000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.728183066508342e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=8.260000000000000e+20 * (T[i] ** (-2.57)) * np.exp(-5.578000000000000e+03 / (Rc * T[i])) + 2.660000000000000e+69 * (T[i] ** (-19.23)) * np.exp(-1.476000000000000e+04 / (Rc * T[i]))
            kfh=7.070000000000001e+33 * (T[i] ** (-6.28)) * np.exp(-1.600000000000000e+04 / (Rc * T[i])) + 1.090000000000000e+11 * (T[i] ** (0.19)) * np.exp(-8.305999999999999e+02 / (Rc * T[i]))
            logPl=1.728183066508342e+01
            logPh=1.843384373047865e+01
        else:
            kfl=7.070000000000001e+33 * (T[i] ** (-6.28)) * np.exp(-1.600000000000000e+04 / (Rc * T[i])) + 1.090000000000000e+11 * (T[i] ** (0.19)) * np.exp(-8.305999999999999e+02 / (Rc * T[i]))
            kfh=7.070000000000001e+33 * (T[i] ** (-6.28)) * np.exp(-1.600000000000000e+04 / (Rc * T[i])) + 1.090000000000000e+11 * (T[i] ** (0.19)) * np.exp(-8.305999999999999e+02 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=8.190000000000000e+18 * (T[i] ** (-2.66)) * np.exp(-3.201000000000000e+03 / (Rc * T[i])) + 1.290000000000000e+09 * (T[i] ** (0.18)) * np.exp(1.717000000000000e+03 / (Rc * T[i]))
            kfh=8.190000000000000e+18 * (T[i] ** (-2.66)) * np.exp(-3.201000000000000e+03 / (Rc * T[i])) + 1.290000000000000e+09 * (T[i] ** (0.18)) * np.exp(1.717000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 3.201869999999998e+05:
            kfl=4.060000000000000e+14 * (T[i] ** (-1.32)) * np.exp(-8.858000000000000e+02 / (Rc * T[i])) + 5.990000000000000e+11 * (T[i] ** (-2.93)) * np.exp(9.564000000000000e+03 / (Rc * T[i]))
            kfh=4.340000000000000e+14 * (T[i] ** (-1.33)) * np.exp(-9.005999999999999e+02 / (Rc * T[i])) + 2.910000000000000e+11 * (T[i] ** (-2.93)) * np.exp(1.012000000000000e+04 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.267666047909533e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=4.340000000000000e+14 * (T[i] ** (-1.33)) * np.exp(-9.005999999999999e+02 / (Rc * T[i])) + 2.910000000000000e+11 * (T[i] ** (-2.93)) * np.exp(1.012000000000000e+04 / (Rc * T[i]))
            kfh=1.030000000000000e+11 * (T[i] ** (-0.33)) * np.exp(7.478000000000000e+02 / (Rc * T[i])) + 5.769999999999999e+21 * (T[i] ** (-3.54)) * np.exp(-4.772000000000000e+03 / (Rc * T[i]))
            logPl=1.267666047909533e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.201870000000002e+06:
            kfl=1.030000000000000e+11 * (T[i] ** (-0.33)) * np.exp(7.478000000000000e+02 / (Rc * T[i])) + 5.769999999999999e+21 * (T[i] ** (-3.54)) * np.exp(-4.772000000000000e+03 / (Rc * T[i]))
            kfh=1.890000000000000e+12 * (T[i] ** (-3.0)) * np.exp(8.995000000000000e+03 / (Rc * T[i])) + 4.990000000000000e+15 * (T[i] ** (-1.62)) * np.exp(-1.849000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.497924557208938e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.890000000000000e+12 * (T[i] ** (-3.0)) * np.exp(8.995000000000000e+03 / (Rc * T[i])) + 4.990000000000000e+15 * (T[i] ** (-1.62)) * np.exp(-1.849000000000000e+03 / (Rc * T[i]))
            kfh=1.930000000000000e+24 * (T[i] ** (-5.63)) * np.exp(-1.800000000000000e+00 / (Rc * T[i])) + 9.330000000000000e+16 * (T[i] ** (-1.96)) * np.exp(-3.324000000000000e+03 / (Rc * T[i]))
            logPl=1.497924557208938e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.201870000000000e+07:
            kfl=1.930000000000000e+24 * (T[i] ** (-5.63)) * np.exp(-1.800000000000000e+00 / (Rc * T[i])) + 9.330000000000000e+16 * (T[i] ** (-1.96)) * np.exp(-3.324000000000000e+03 / (Rc * T[i]))
            kfh=1.100000000000000e+18 * (T[i] ** (-2.22)) * np.exp(-5.178000000000000e+03 / (Rc * T[i])) + 1.020000000000000e+72 * (T[i] ** (-20.69)) * np.exp(-1.586000000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.728183066508342e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=1.100000000000000e+18 * (T[i] ** (-2.22)) * np.exp(-5.178000000000000e+03 / (Rc * T[i])) + 1.020000000000000e+72 * (T[i] ** (-20.69)) * np.exp(-1.586000000000000e+04 / (Rc * T[i]))
            kfh=5.790000000000000e+32 * (T[i] ** (-6.45)) * np.exp(-1.681000000000000e+04 / (Rc * T[i])) + 1.100000000000000e+09 * (T[i] ** (0.31)) * np.exp(-1.024000000000000e+03 / (Rc * T[i]))
            logPl=1.728183066508342e+01
            logPh=1.843384373047865e+01
        else:
            kfl=5.790000000000000e+32 * (T[i] ** (-6.45)) * np.exp(-1.681000000000000e+04 / (Rc * T[i])) + 1.100000000000000e+09 * (T[i] ** (0.31)) * np.exp(-1.024000000000000e+03 / (Rc * T[i]))
            kfh=5.790000000000000e+32 * (T[i] ** (-6.45)) * np.exp(-1.681000000000000e+04 / (Rc * T[i])) + 1.100000000000000e+09 * (T[i] ** (0.31)) * np.exp(-1.024000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=2.370000000000000e+35 * (T[i] ** (-7.76)) * np.exp(-1.263000000000000e+04 / (Rc * T[i])) + 6.270000000000000e+13 * (T[i] ** (-1.16)) * np.exp(-4.063000000000000e+02 / (Rc * T[i]))
            kfh=2.370000000000000e+35 * (T[i] ** (-7.76)) * np.exp(-1.263000000000000e+04 / (Rc * T[i])) + 6.270000000000000e+13 * (T[i] ** (-1.16)) * np.exp(-4.063000000000000e+02 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 3.201869999999998e+05:
            kfl=1.730000000000000e+35 * (T[i] ** (-7.72)) * np.exp(-1.252000000000000e+04 / (Rc * T[i])) + 6.240000000000000e+13 * (T[i] ** (-1.16)) * np.exp(-4.014000000000000e+02 / (Rc * T[i]))
            kfh=4.470000000000001e+34 * (T[i] ** (-7.55)) * np.exp(-1.214000000000000e+04 / (Rc * T[i])) + 6.120000000000000e+13 * (T[i] ** (-1.16)) * np.exp(-3.970000000000000e+02 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.267666047909533e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=4.470000000000001e+34 * (T[i] ** (-7.55)) * np.exp(-1.214000000000000e+04 / (Rc * T[i])) + 6.120000000000000e+13 * (T[i] ** (-1.16)) * np.exp(-3.970000000000000e+02 / (Rc * T[i]))
            kfh=7.250000000000001e+31 * (T[i] ** (-6.7)) * np.exp(-1.044000000000000e+04 / (Rc * T[i])) + 5.320000000000000e+13 * (T[i] ** (-1.14)) * np.exp(-4.467000000000000e+02 / (Rc * T[i]))
            logPl=1.267666047909533e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.201870000000002e+06:
            kfl=7.250000000000001e+31 * (T[i] ** (-6.7)) * np.exp(-1.044000000000000e+04 / (Rc * T[i])) + 5.320000000000000e+13 * (T[i] ** (-1.14)) * np.exp(-4.467000000000000e+02 / (Rc * T[i]))
            kfh=3.630000000000000e+35 * (T[i] ** (-7.75)) * np.exp(-1.283000000000000e+04 / (Rc * T[i])) + 1.450000000000000e+14 * (T[i] ** (-1.26)) * np.exp(-9.877000000000000e+02 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.497924557208938e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=3.630000000000000e+35 * (T[i] ** (-7.75)) * np.exp(-1.283000000000000e+04 / (Rc * T[i])) + 1.450000000000000e+14 * (T[i] ** (-1.26)) * np.exp(-9.877000000000000e+02 / (Rc * T[i]))
            kfh=2.090000000000000e+35 * (T[i] ** (-7.53)) * np.exp(-1.405000000000000e+04 / (Rc * T[i])) + 5.020000000000000e+13 * (T[i] ** (-1.11)) * np.exp(-1.409000000000000e+03 / (Rc * T[i]))
            logPl=1.497924557208938e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.201870000000000e+07:
            kfl=2.090000000000000e+35 * (T[i] ** (-7.53)) * np.exp(-1.405000000000000e+04 / (Rc * T[i])) + 5.020000000000000e+13 * (T[i] ** (-1.11)) * np.exp(-1.409000000000000e+03 / (Rc * T[i]))
            kfh=3.840000000000000e+18 * (T[i] ** (-2.44)) * np.exp(-5.408000000000000e+03 / (Rc * T[i])) + 1.400000000000000e+70 * (T[i] ** (-20.11)) * np.exp(-1.543000000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.728183066508342e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=3.840000000000000e+18 * (T[i] ** (-2.44)) * np.exp(-5.408000000000000e+03 / (Rc * T[i])) + 1.400000000000000e+70 * (T[i] ** (-20.11)) * np.exp(-1.543000000000000e+04 / (Rc * T[i]))
            kfh=1.210000000000000e+32 * (T[i] ** (-6.32)) * np.exp(-1.619000000000000e+04 / (Rc * T[i])) + 9.210000000000000e+08 * (T[i] ** (0.25)) * np.exp(-8.553000000000000e+02 / (Rc * T[i]))
            logPl=1.728183066508342e+01
            logPh=1.843384373047865e+01
        else:
            kfl=1.210000000000000e+32 * (T[i] ** (-6.32)) * np.exp(-1.619000000000000e+04 / (Rc * T[i])) + 9.210000000000000e+08 * (T[i] ** (0.25)) * np.exp(-8.553000000000000e+02 / (Rc * T[i]))
            kfh=1.210000000000000e+32 * (T[i] ** (-6.32)) * np.exp(-1.619000000000000e+04 / (Rc * T[i])) + 9.210000000000000e+08 * (T[i] ** (0.25)) * np.exp(-8.553000000000000e+02 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=1.578000000000000e+03 * (T[i] ** (2.56)) * np.exp(8.445000000000000e+02 / (Rc * T[i]))
            kfh=1.578000000000000e+03 * (T[i] ** (2.56)) * np.exp(8.445000000000000e+02 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000001e+05:
            kfl=1.518000000000000e+04 * (T[i] ** (2.28)) * np.exp(2.921000000000000e+02 / (Rc * T[i]))
            kfh=3.017000000000000e+05 * (T[i] ** (1.92)) * np.exp(-5.980999999999999e+02 / (Rc * T[i]))
            logPl=1.013979409037662e+01
            logPh=1.152608845149651e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=3.017000000000000e+05 * (T[i] ** (1.92)) * np.exp(-5.980999999999999e+02 / (Rc * T[i]))
            kfh=7.528000000000000e+06 * (T[i] ** (1.55)) * np.exp(-2.106000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=7.528000000000000e+06 * (T[i] ** (1.55)) * np.exp(-2.106000000000000e+03 / (Rc * T[i]))
            kfh=5.101000000000000e+06 * (T[i] ** (1.65)) * np.exp(-3.400000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=5.101000000000000e+06 * (T[i] ** (1.65)) * np.exp(-3.400000000000000e+03 / (Rc * T[i]))
            kfh=1.457000000000000e+04 * (T[i] ** (2.45)) * np.exp(-4.477000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=1.457000000000000e+04 * (T[i] ** (2.45)) * np.exp(-4.477000000000000e+03 / (Rc * T[i]))
            kfh=1.457000000000000e+04 * (T[i] ** (2.45)) * np.exp(-4.477000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=4.757000000000000e+05 * (T[i] ** (1.68)) * np.exp(3.298000000000000e+02 / (Rc * T[i]))
            kfh=4.757000000000000e+05 * (T[i] ** (1.68)) * np.exp(3.298000000000000e+02 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000001e+05:
            kfl=4.372000000000000e+06 * (T[i] ** (1.4)) * np.exp(-2.265000000000000e+02 / (Rc * T[i]))
            kfh=7.648000000000000e+07 * (T[i] ** (1.05)) * np.exp(-1.115000000000000e+03 / (Rc * T[i]))
            logPl=1.013979409037662e+01
            logPh=1.152608845149651e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=7.648000000000000e+07 * (T[i] ** (1.05)) * np.exp(-1.115000000000000e+03 / (Rc * T[i]))
            kfh=1.277000000000000e+09 * (T[i] ** (0.73)) * np.exp(-2.579000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.277000000000000e+09 * (T[i] ** (0.73)) * np.exp(-2.579000000000000e+03 / (Rc * T[i]))
            kfh=4.312000000000000e+08 * (T[i] ** (0.92)) * np.exp(-3.736000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=4.312000000000000e+08 * (T[i] ** (0.92)) * np.exp(-3.736000000000000e+03 / (Rc * T[i]))
            kfh=8.250000000000001e+05 * (T[i] ** (1.77)) * np.exp(-4.697000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=8.250000000000001e+05 * (T[i] ** (1.77)) * np.exp(-4.697000000000000e+03 / (Rc * T[i]))
            kfh=8.250000000000001e+05 * (T[i] ** (1.77)) * np.exp(-4.697000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=9.100000000000000e+13 * (T[i] ** (-1.17)) * np.exp(-1.375000000000000e+04 / (Rc * T[i])) + 1.970000000000000e+01 * (T[i] ** (2.56)) * np.exp(-7.382000000000000e+03 / (Rc * T[i]))
            kfh=9.100000000000000e+13 * (T[i] ** (-1.17)) * np.exp(-1.375000000000000e+04 / (Rc * T[i])) + 1.970000000000000e+01 * (T[i] ** (2.56)) * np.exp(-7.382000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 3.201869999999998e+05:
            kfl=9.940000000000000e+00 * (T[i] ** (2.64)) * np.exp(-7.253000000000000e+03 / (Rc * T[i])) + 3.630000000000000e+13 * (T[i] ** (-1.05)) * np.exp(-1.352000000000000e+04 / (Rc * T[i]))
            kfh=6.050000000000001e-06 * (T[i] ** (4.34)) * np.exp(-4.525000000000000e+03 / (Rc * T[i])) + 1.610000000000000e+10 * np.exp(-1.172000000000000e+04 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.267666047909533e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=6.050000000000001e-06 * (T[i] ** (4.34)) * np.exp(-4.525000000000000e+03 / (Rc * T[i])) + 1.610000000000000e+10 * np.exp(-1.172000000000000e+04 / (Rc * T[i]))
            kfh=7.770000000000000e+102 * (T[i] ** (-24.18)) * np.exp(-1.386000000000000e+05 / (Rc * T[i])) + 1.880000000000000e+08 * (T[i] ** (0.6)) * np.exp(-1.085000000000000e+04 / (Rc * T[i]))
            logPl=1.267666047909533e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.201870000000002e+06:
            kfl=7.770000000000000e+102 * (T[i] ** (-24.18)) * np.exp(-1.386000000000000e+05 / (Rc * T[i])) + 1.880000000000000e+08 * (T[i] ** (0.6)) * np.exp(-1.085000000000000e+04 / (Rc * T[i]))
            kfh=1.220000000000000e+16 * (T[i] ** (-1.75)) * np.exp(-1.518000000000000e+04 / (Rc * T[i])) + 8.260000000000000e+00 * (T[i] ** (2.69)) * np.exp(-8.025000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.497924557208938e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.220000000000000e+16 * (T[i] ** (-1.75)) * np.exp(-1.518000000000000e+04 / (Rc * T[i])) + 8.260000000000000e+00 * (T[i] ** (2.69)) * np.exp(-8.025000000000000e+03 / (Rc * T[i]))
            kfh=1.710000000000000e+36 * (T[i] ** (-7.77)) * np.exp(-2.697000000000000e+04 / (Rc * T[i])) + 2.300000000000000e+07 * (T[i] ** (0.91)) * np.exp(-1.171000000000000e+04 / (Rc * T[i]))
            logPl=1.497924557208938e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.201870000000000e+07:
            kfl=1.710000000000000e+36 * (T[i] ** (-7.77)) * np.exp(-2.697000000000000e+04 / (Rc * T[i])) + 2.300000000000000e+07 * (T[i] ** (0.91)) * np.exp(-1.171000000000000e+04 / (Rc * T[i]))
            kfh=4.140000000000001e+28 * (T[i] ** (-5.3)) * np.exp(-2.513000000000000e+04 / (Rc * T[i])) + 4.190000000000000e+04 * (T[i] ** (1.7)) * np.exp(-1.125000000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.728183066508342e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=4.140000000000001e+28 * (T[i] ** (-5.3)) * np.exp(-2.513000000000000e+04 / (Rc * T[i])) + 4.190000000000000e+04 * (T[i] ** (1.7)) * np.exp(-1.125000000000000e+04 / (Rc * T[i]))
            kfh=5.770000000000000e+16 * (T[i] ** (-1.7)) * np.exp(-2.003000000000000e+04 / (Rc * T[i])) + 1.010000000000000e-05 * (T[i] ** (4.31)) * np.exp(-6.829000000000000e+03 / (Rc * T[i]))
            logPl=1.728183066508342e+01
            logPh=1.843384373047865e+01
        else:
            kfl=5.770000000000000e+16 * (T[i] ** (-1.7)) * np.exp(-2.003000000000000e+04 / (Rc * T[i])) + 1.010000000000000e-05 * (T[i] ** (4.31)) * np.exp(-6.829000000000000e+03 / (Rc * T[i]))
            kfh=5.770000000000000e+16 * (T[i] ** (-1.7)) * np.exp(-2.003000000000000e+04 / (Rc * T[i])) + 1.010000000000000e-05 * (T[i] ** (4.31)) * np.exp(-6.829000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+02:
            kfl=1.170000000000000e+12 * (T[i] ** (-0.11)) * np.exp(-3.670000000000000e+01 / (Rc * T[i])) + 3.610000000000001e-15 * (T[i] ** (-15.54)) * np.exp(9.058000000000000e+04 / (Rc * T[i]))
            kfh=1.170000000000000e+12 * (T[i] ** (-0.11)) * np.exp(-3.670000000000000e+01 / (Rc * T[i])) + 3.610000000000001e-15 * (T[i] ** (-15.54)) * np.exp(9.058000000000000e+04 / (Rc * T[i]))
            logPl=1.0e0
            logPh=4.618333172514372e+00
        elif P[i] < 1.013250000000000e+04:
            kfl=1.170000000000000e+12 * (T[i] ** (-0.11)) * np.exp(-3.640000000000000e+01 / (Rc * T[i])) + 2.810000000000000e-07 * (T[i] ** (-0.8)) * np.exp(2.658000000000000e+04 / (Rc * T[i]))
            kfh=1.540000000000000e+12 * (T[i] ** (-0.15)) * np.exp(-1.334000000000000e+02 / (Rc * T[i])) + 1.340000000000000e-08 * (T[i] ** (-0.62)) * np.exp(2.788000000000000e+04 / (Rc * T[i]))
            logPl=6.920918265508418e+00
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000000e+06:
            kfl=1.540000000000000e+12 * (T[i] ** (-0.15)) * np.exp(-1.334000000000000e+02 / (Rc * T[i])) + 1.340000000000000e-08 * (T[i] ** (-0.62)) * np.exp(2.788000000000000e+04 / (Rc * T[i]))
            kfh=2.700000000000000e+25 * (T[i] ** (-3.95)) * np.exp(-9.988000000000000e+03 / (Rc * T[i])) + 3.060000000000000e+08 * (T[i] ** (0.91)) * np.exp(-3.748000000000000e+02 / (Rc * T[i]))
            logPl=9.223503358502464e+00
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=2.700000000000000e+25 * (T[i] ** (-3.95)) * np.exp(-9.988000000000000e+03 / (Rc * T[i])) + 3.060000000000000e+08 * (T[i] ** (0.91)) * np.exp(-3.748000000000000e+02 / (Rc * T[i]))
            kfh=4.640000000000000e+23 * (T[i] ** (-3.26)) * np.exp(-1.290000000000000e+04 / (Rc * T[i])) + 3.920000000000000e+05 * (T[i] ** (1.68)) * np.exp(-4.316000000000000e+02 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 2.026499999999999e+07:
            kfl=4.640000000000000e+23 * (T[i] ** (-3.26)) * np.exp(-1.290000000000000e+04 / (Rc * T[i])) + 3.920000000000000e+05 * (T[i] ** (1.68)) * np.exp(-4.316000000000000e+02 / (Rc * T[i]))
            kfh=4.580000000000001e+22 * (T[i] ** (-2.93)) * np.exp(-1.361000000000000e+04 / (Rc * T[i])) + 4.220000000000001e+04 * (T[i] ** (1.93)) * np.exp(-3.485000000000000e+02 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.682440581804455e+01
        elif P[i] < 5.066250000000001e+07:
            kfl=4.580000000000001e+22 * (T[i] ** (-2.93)) * np.exp(-1.361000000000000e+04 / (Rc * T[i])) + 4.220000000000001e+04 * (T[i] ** (1.93)) * np.exp(-3.485000000000000e+02 / (Rc * T[i]))
            kfh=1.700000000000000e+22 * (T[i] ** (-2.76)) * np.exp(-1.525000000000000e+04 / (Rc * T[i])) + 9.900000000000001e+02 * (T[i] ** (2.38)) * np.exp(-1.964000000000000e+02 / (Rc * T[i]))
            logPl=1.682440581804455e+01
            logPh=1.774069654991870e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=1.700000000000000e+22 * (T[i] ** (-2.76)) * np.exp(-1.525000000000000e+04 / (Rc * T[i])) + 9.900000000000001e+02 * (T[i] ** (2.38)) * np.exp(-1.964000000000000e+02 / (Rc * T[i]))
            kfh=9.590000000000001e+21 * (T[i] ** (-2.66)) * np.exp(-1.667000000000000e+04 / (Rc * T[i])) + 2.670000000000000e+01 * (T[i] ** (2.83)) * np.exp(-3.000000000000000e+00 / (Rc * T[i]))
            logPl=1.774069654991870e+01
            logPh=1.843384373047865e+01
        else:
            kfl=9.590000000000001e+21 * (T[i] ** (-2.66)) * np.exp(-1.667000000000000e+04 / (Rc * T[i])) + 2.670000000000000e+01 * (T[i] ** (2.83)) * np.exp(-3.000000000000000e+00 / (Rc * T[i]))
            kfh=9.590000000000001e+21 * (T[i] ** (-2.66)) * np.exp(-1.667000000000000e+04 / (Rc * T[i])) + 2.670000000000000e+01 * (T[i] ** (2.83)) * np.exp(-3.000000000000000e+00 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=1.770000000000000e+19 * (T[i] ** (-1.94)) * np.exp(-6.790000000000000e+03 / (Rc * T[i])) + 4.300000000000000e+12 * (T[i] ** (0.19)) * np.exp(1.104100000000000e+02 / (Rc * T[i]))
            kfh=1.770000000000000e+19 * (T[i] ** (-1.94)) * np.exp(-6.790000000000000e+03 / (Rc * T[i])) + 4.300000000000000e+12 * (T[i] ** (0.19)) * np.exp(1.104100000000000e+02 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000000e+06:
            kfl=1.680000000000000e+19 * (T[i] ** (-1.8)) * np.exp(-4.310000000000000e+03 / (Rc * T[i])) + 2.260000000000000e+11 * (T[i] ** (0.54)) * np.exp(-4.781000000000000e+01 / (Rc * T[i]))
            kfh=4.160000000000000e+24 * (T[i] ** (-3.19)) * np.exp(-9.760000000000000e+03 / (Rc * T[i])) + 4.920000000000000e+09 * (T[i] ** (1.02)) * np.exp(-5.997699999999999e+02 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.382867354449055e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=4.160000000000000e+24 * (T[i] ** (-3.19)) * np.exp(-9.760000000000000e+03 / (Rc * T[i])) + 4.920000000000000e+09 * (T[i] ** (1.02)) * np.exp(-5.997699999999999e+02 / (Rc * T[i]))
            kfh=7.889999999999999e+24 * (T[i] ** (-3.07)) * np.exp(-1.390000000000000e+04 / (Rc * T[i])) + 1.470000000000000e+08 * (T[i] ** (1.33)) * np.exp(-1.228400000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=7.889999999999999e+24 * (T[i] ** (-3.07)) * np.exp(-1.390000000000000e+04 / (Rc * T[i])) + 1.470000000000000e+08 * (T[i] ** (1.33)) * np.exp(-1.228400000000000e+03 / (Rc * T[i]))
            kfh=7.359999999999999e+29 * (T[i] ** (-4.28)) * np.exp(-2.380000000000000e+04 / (Rc * T[i])) + 8.110000000000000e+10 * (T[i] ** (0.55)) * np.exp(-5.506500000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.843384373047865e+01
        else:
            kfl=7.359999999999999e+29 * (T[i] ** (-4.28)) * np.exp(-2.380000000000000e+04 / (Rc * T[i])) + 8.110000000000000e+10 * (T[i] ** (0.55)) * np.exp(-5.506500000000000e+03 / (Rc * T[i]))
            kfh=7.359999999999999e+29 * (T[i] ** (-4.28)) * np.exp(-2.380000000000000e+04 / (Rc * T[i])) + 8.110000000000000e+10 * (T[i] ** (0.55)) * np.exp(-5.506500000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    # Reaction HCNO <=> HCN + O
    for i in range(veclen):
        if P[i] < 1.013250000000001e+05:
            kfl=2.000000000000000e+30 * (T[i] ** (-6.03)) * np.exp(-6.073300000000000e+04 / (Rc * T[i]))
            kfh=2.000000000000000e+30 * (T[i] ** (-6.03)) * np.exp(-6.073300000000000e+04 / (Rc * T[i]))
            logPl=1.0e0
            logPh=1.152608845149651e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=4.200000000000000e+31 * (T[i] ** (-6.12)) * np.exp(-6.121000000000000e+04 / (Rc * T[i]))
            kfh=5.900000000000000e+31 * (T[i] ** (-5.85)) * np.exp(-6.193500000000000e+04 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        else:
            kfl=5.900000000000000e+31 * (T[i] ** (-5.85)) * np.exp(-6.193500000000000e+04 / (Rc * T[i]))
            kfh=5.900000000000000e+31 * (T[i] ** (-5.85)) * np.exp(-6.193500000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=5.900000000000000e+08 * (T[i] ** (1.06)) * np.exp(-1.596000000000000e+04 / (Rc * T[i]))
            kfh=5.900000000000000e+08 * (T[i] ** (1.06)) * np.exp(-1.596000000000000e+04 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000001e+05:
            kfl=5.900000000000000e+08 * (T[i] ** (1.06)) * np.exp(-1.595000000000000e+04 / (Rc * T[i]))
            kfh=6.200000000000000e+08 * (T[i] ** (1.05)) * np.exp(-1.596000000000000e+04 / (Rc * T[i]))
            logPl=1.032211564717057e+01
            logPh=1.152608845149651e+01
        elif P[i] < 3.039750000000000e+05:
            kfl=6.200000000000000e+08 * (T[i] ** (1.05)) * np.exp(-1.596000000000000e+04 / (Rc * T[i]))
            kfh=9.000000000000000e+08 * (T[i] ** (1.01)) * np.exp(-1.612000000000000e+04 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.262470074016462e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=9.000000000000000e+08 * (T[i] ** (1.01)) * np.exp(-1.612000000000000e+04 / (Rc * T[i]))
            kfh=2.500000000000000e+09 * (T[i] ** (0.89)) * np.exp(-1.662000000000000e+04 / (Rc * T[i]))
            logPl=1.262470074016462e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.039749999999998e+06:
            kfl=2.500000000000000e+09 * (T[i] ** (0.89)) * np.exp(-1.662000000000000e+04 / (Rc * T[i]))
            kfh=9.200000000000000e+09 * (T[i] ** (0.75)) * np.exp(-1.741000000000000e+04 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.492728583315866e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=9.200000000000000e+09 * (T[i] ** (0.75)) * np.exp(-1.741000000000000e+04 / (Rc * T[i]))
            kfh=3.000000000000000e+10 * (T[i] ** (0.62)) * np.exp(-1.848000000000000e+04 / (Rc * T[i]))
            logPl=1.492728583315866e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.039750000000001e+07:
            kfl=3.000000000000000e+10 * (T[i] ** (0.62)) * np.exp(-1.848000000000000e+04 / (Rc * T[i]))
            kfh=3.800000000000000e+10 * (T[i] ** (0.62)) * np.exp(-1.946000000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.722987092615271e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=3.800000000000000e+10 * (T[i] ** (0.62)) * np.exp(-1.946000000000000e+04 / (Rc * T[i]))
            kfh=9.500000000000000e+09 * (T[i] ** (0.81)) * np.exp(-2.034000000000000e+04 / (Rc * T[i]))
            logPl=1.722987092615271e+01
            logPh=1.843384373047865e+01
        else:
            kfl=9.500000000000000e+09 * (T[i] ** (0.81)) * np.exp(-2.034000000000000e+04 / (Rc * T[i]))
            kfh=9.500000000000000e+09 * (T[i] ** (0.81)) * np.exp(-2.034000000000000e+04 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=6.000000000000001e+23 * (T[i] ** (-4.41)) * np.exp(-1.441000000000000e+04 / (Rc * T[i]))
            kfh=6.000000000000001e+23 * (T[i] ** (-4.41)) * np.exp(-1.441000000000000e+04 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000001e+05:
            kfl=7.300000000000001e+23 * (T[i] ** (-4.3)) * np.exp(-1.476000000000000e+04 / (Rc * T[i]))
            kfh=7.300000000000001e+23 * (T[i] ** (-4.17)) * np.exp(-1.520000000000000e+04 / (Rc * T[i]))
            logPl=1.032211564717057e+01
            logPh=1.152608845149651e+01
        elif P[i] < 3.039750000000000e+05:
            kfl=7.300000000000001e+23 * (T[i] ** (-4.17)) * np.exp(-1.520000000000000e+04 / (Rc * T[i]))
            kfh=4.800000000000000e+23 * (T[i] ** (-4.0)) * np.exp(-1.557000000000000e+04 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.262470074016462e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=4.800000000000000e+23 * (T[i] ** (-4.0)) * np.exp(-1.557000000000000e+04 / (Rc * T[i]))
            kfh=1.400000000000000e+23 * (T[i] ** (-3.74)) * np.exp(-1.582000000000000e+04 / (Rc * T[i]))
            logPl=1.262470074016462e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.039749999999998e+06:
            kfl=1.400000000000000e+23 * (T[i] ** (-3.74)) * np.exp(-1.582000000000000e+04 / (Rc * T[i]))
            kfh=1.700000000000000e+22 * (T[i] ** (-3.38)) * np.exp(-1.584000000000000e+04 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.492728583315866e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.700000000000000e+22 * (T[i] ** (-3.38)) * np.exp(-1.584000000000000e+04 / (Rc * T[i]))
            kfh=6.800000000000000e+20 * (T[i] ** (-2.9)) * np.exp(-1.569000000000000e+04 / (Rc * T[i]))
            logPl=1.492728583315866e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.039750000000001e+07:
            kfl=6.800000000000000e+20 * (T[i] ** (-2.9)) * np.exp(-1.569000000000000e+04 / (Rc * T[i]))
            kfh=1.800000000000000e+19 * (T[i] ** (-2.37)) * np.exp(-1.543000000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.722987092615271e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=1.800000000000000e+19 * (T[i] ** (-2.37)) * np.exp(-1.543000000000000e+04 / (Rc * T[i]))
            kfh=3.100000000000000e+17 * (T[i] ** (-1.78)) * np.exp(-1.524000000000000e+04 / (Rc * T[i]))
            logPl=1.722987092615271e+01
            logPh=1.843384373047865e+01
        else:
            kfl=3.100000000000000e+17 * (T[i] ** (-1.78)) * np.exp(-1.524000000000000e+04 / (Rc * T[i]))
            kfh=3.100000000000000e+17 * (T[i] ** (-1.78)) * np.exp(-1.524000000000000e+04 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=3.900000000000000e+23 * (T[i] ** (-4.34)) * np.exp(-5.347000000000000e+03 / (Rc * T[i]))
            kfh=3.900000000000000e+23 * (T[i] ** (-4.34)) * np.exp(-5.347000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000001e+05:
            kfl=3.300000000000000e+25 * (T[i] ** (-4.71)) * np.exp(-4.102000000000000e+03 / (Rc * T[i]))
            kfh=5.600000000000001e+27 * (T[i] ** (-5.13)) * np.exp(-3.741000000000000e+03 / (Rc * T[i]))
            logPl=1.032211564717057e+01
            logPh=1.152608845149651e+01
        elif P[i] < 3.039750000000000e+05:
            kfl=5.600000000000001e+27 * (T[i] ** (-5.13)) * np.exp(-3.741000000000000e+03 / (Rc * T[i]))
            kfh=1.700000000000000e+29 * (T[i] ** (-5.36)) * np.exp(-3.947000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.262470074016462e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=1.700000000000000e+29 * (T[i] ** (-5.36)) * np.exp(-3.947000000000000e+03 / (Rc * T[i]))
            kfh=1.500000000000000e+30 * (T[i] ** (-5.43)) * np.exp(-4.415000000000000e+03 / (Rc * T[i]))
            logPl=1.262470074016462e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.039749999999998e+06:
            kfl=1.500000000000000e+30 * (T[i] ** (-5.43)) * np.exp(-4.415000000000000e+03 / (Rc * T[i]))
            kfh=2.600000000000000e+30 * (T[i] ** (-5.34)) * np.exp(-4.870000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.492728583315866e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=2.600000000000000e+30 * (T[i] ** (-5.34)) * np.exp(-4.870000000000000e+03 / (Rc * T[i]))
            kfh=1.200000000000000e+30 * (T[i] ** (-5.09)) * np.exp(-5.275000000000000e+03 / (Rc * T[i]))
            logPl=1.492728583315866e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.039750000000001e+07:
            kfl=1.200000000000000e+30 * (T[i] ** (-5.09)) * np.exp(-5.275000000000000e+03 / (Rc * T[i]))
            kfh=1.900000000000000e+29 * (T[i] ** (-4.72)) * np.exp(-5.476000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.722987092615271e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=1.900000000000000e+29 * (T[i] ** (-4.72)) * np.exp(-5.476000000000000e+03 / (Rc * T[i]))
            kfh=5.100000000000000e+27 * (T[i] ** (-4.15)) * np.exp(-5.370000000000000e+03 / (Rc * T[i]))
            logPl=1.722987092615271e+01
            logPh=1.843384373047865e+01
        else:
            kfl=5.100000000000000e+27 * (T[i] ** (-4.15)) * np.exp(-5.370000000000000e+03 / (Rc * T[i]))
            kfh=5.100000000000000e+27 * (T[i] ** (-4.15)) * np.exp(-5.370000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=2.200000000000000e+11 * (T[i] ** (0.71)) * np.exp(-5.321000000000000e+03 / (Rc * T[i]))
            kfh=2.200000000000000e+11 * (T[i] ** (0.71)) * np.exp(-5.321000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000001e+05:
            kfl=2.200000000000000e+11 * (T[i] ** (0.71)) * np.exp(-5.321000000000000e+03 / (Rc * T[i]))
            ...
            kfl=2.200000000000000e+11 * (T[i] ** (0.71)) * np.exp(-5.321000000000000e+03 / (Rc * T[i]))
            kfh=2.200000000000000e+11 * (T[i] ** (0.71)) * np.exp(-5.322000000000000e+03 / (Rc * T[i]))
            logPl=1.492728583315866e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.039750000000001e+07:
            kfl=2.200000000000000e+11 * (T[i] ** (0.71)) * np.exp(-5.322000000000000e+03 / (Rc * T[i]))
            kfh=2.300000000000000e+11 * (T[i] ** (0.7)) * np.exp(-5.327000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.722987092615271e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=2.300000000000000e+11 * (T[i] ** (0.7)) * np.exp(-5.327000000000000e+03 / (Rc * T[i]))
            kfh=2.500000000000000e+11 * (T[i] ** (0.69)) * np.exp(-5.371000000000000e+03 / (Rc * T[i]))
            logPl=1.722987092615271e+01
            logPh=1.843384373047865e+01
        else:
            kfl=2.500000000000000e+11 * (T[i] ** (0.69)) * np.exp(-5.371000000000000e+03 / (Rc * T[i]))
            kfh=2.500000000000000e+11 * (T[i] ** (0.69)) * np.exp(-5.371000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=3.900000000000000e-04 * (T[i] ** (4.7)) * np.exp(-2.440000000000000e+03 / (Rc * T[i]))
            kfh=3.900000000000000e-04 * (T[i] ** (4.7)) * np.exp(-2.440000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 1.013250000000001e+05:
            kfl=3.900000000000000e-04 * (T[i] ** (4.7)) * np.exp(-2.440000000000000e+03 / (Rc * T[i]))
            kfh=4.000000000000000e-04 * (T[i] ** (4.7)) * np.exp(-2.440000000000000e+03 / (Rc * T[i]))
            logPl=1.032211564717057e+01
            logPh=1.152608845149651e+01
        elif P[i] < 3.039750000000000e+05:
            kfl=4.000000000000000e-04 * (T[i] ** (4.7)) * np.exp(-2.440000000000000e+03 / (Rc * T[i]))
            kfh=4.000000000000000e-04 * (T[i] ** (4.7)) * np.exp(-2.438000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.262470074016462e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=4.000000000000000e-04 * (T[i] ** (4.7)) * np.exp(-2.438000000000000e+03 / (Rc * T[i]))
            kfh=4.300000000000000e-04 * (T[i] ** (4.69)) * np.exp(-2.434000000000000e+03 / (Rc * T[i]))
            logPl=1.262470074016462e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.039749999999998e+06:
            kfl=4.300000000000000e-04 * (T[i] ** (4.69)) * np.exp(-2.434000000000000e+03 / (Rc * T[i]))
            kfh=4.900000000000000e-04 * (T[i] ** (4.67)) * np.exp(-2.423000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.492728583315866e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=4.900000000000000e-04 * (T[i] ** (4.67)) * np.exp(-2.423000000000000e+03 / (Rc * T[i]))
            kfh=7.100000000000000e-04 * (T[i] ** (4.62)) * np.exp(-2.408000000000000e+03 / (Rc * T[i]))
            logPl=1.492728583315866e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.039750000000001e+07:
            kfl=7.100000000000000e-04 * (T[i] ** (4.62)) * np.exp(-2.408000000000000e+03 / (Rc * T[i]))
            kfh=1.700000000000000e-03 * (T[i] ** (4.52)) * np.exp(-2.622000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.722987092615271e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=1.700000000000000e-03 * (T[i] ** (4.52)) * np.exp(-2.622000000000000e+03 / (Rc * T[i]))
            kfh=9.599999999999999e-03 * (T[i] ** (4.32)) * np.exp(-3.641000000000000e+03 / (Rc * T[i]))
            logPl=1.722987092615271e+01
            logPh=1.843384373047865e+01
        else:
            kfl=9.599999999999999e-03 * (T[i] ** (4.32)) * np.exp(-3.641000000000000e+03 / (Rc * T[i]))
            kfh=9.599999999999999e-03 * (T[i] ** (4.32)) * np.exp(-3.641000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=8.600000000000000e+14 * (T[i] ** (-0.95)) * np.exp(-7.340000000000000e+02 / (Rc * T[i]))
            kfh=8.600000000000000e+14 * (T[i] ** (-0.95)) * np.exp(-7.340000000000000e+02 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 5.066250000000003e+04:
            kfl=2.600000000000000e+15 * (T[i] ** (-1.08)) * np.exp(-1.128000000000000e+03 / (Rc * T[i]))
            kfh=5.400000000000000e+15 * (T[i] ** (-1.17)) * np.exp(-1.391000000000000e+03 / (Rc * T[i]))
            logPl=1.032211564717057e+01
            logPh=1.083294127093656e+01
        elif P[i] < 1.013250000000001e+05:
            kfl=5.400000000000000e+15 * (T[i] ** (-1.17)) * np.exp(-1.391000000000000e+03 / (Rc * T[i]))
            kfh=1.700000000000000e+16 * (T[i] ** (-1.3)) * np.exp(-1.843000000000000e+03 / (Rc * T[i]))
            logPl=1.083294127093656e+01
            logPh=1.152608845149651e+01
        elif P[i] < 3.039750000000000e+05:
            kfl=1.700000000000000e+16 * (T[i] ** (-1.3)) * np.exp(-1.843000000000000e+03 / (Rc * T[i]))
            kfh=1.400000000000000e+17 * (T[i] ** (-1.55)) * np.exp(-2.791000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.262470074016462e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=1.400000000000000e+17 * (T[i] ** (-1.55)) * np.exp(-2.791000000000000e+03 / (Rc * T[i]))
            kfh=1.700000000000000e+18 * (T[i] ** (-1.83)) * np.exp(-4.143000000000000e+03 / (Rc * T[i]))
            logPl=1.262470074016462e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.039749999999998e+06:
            kfl=1.700000000000000e+18 * (T[i] ** (-1.83)) * np.exp(-4.143000000000000e+03 / (Rc * T[i]))
            kfh=1.000000000000000e+19 * (T[i] ** (-2.03)) * np.exp(-5.607000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.492728583315866e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.000000000000000e+19 * (T[i] ** (-2.03)) * np.exp(-5.607000000000000e+03 / (Rc * T[i]))
            kfh=2.200000000000000e+19 * (T[i] ** (-2.08)) * np.exp(-7.339000000000000e+03 / (Rc * T[i]))
            logPl=1.492728583315866e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.039750000000001e+07:
            kfl=2.200000000000000e+19 * (T[i] ** (-2.08)) * np.exp(-7.339000000000000e+03 / (Rc * T[i]))
            kfh=6.400000000000000e+18 * (T[i] ** (-1.88)) * np.exp(-8.866000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.722987092615271e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=6.400000000000000e+18 * (T[i] ** (-1.88)) * np.exp(-8.866000000000000e+03 / (Rc * T[i]))
            kfh=6.300000000000000e+16 * (T[i] ** (-1.25)) * np.exp(-1.022000000000000e+04 / (Rc * T[i]))
            logPl=1.722987092615271e+01
            logPh=1.843384373047865e+01
        else:
            kfl=6.300000000000000e+16 * (T[i] ** (-1.25)) * np.exp(-1.022000000000000e+04 / (Rc * T[i]))
            kfh=6.300000000000000e+16 * (T[i] ** (-1.25)) * np.exp(-1.022000000000000e+04 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=2.900000000000000e+05 * (T[i] ** (2.04)) * np.exp(-1.505000000000000e+03 / (Rc * T[i]))
            kfh=2.900000000000000e+05 * (T[i] ** (2.04)) * np.exp(-1.505000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 5.066250000000003e+04:
            kfl=6.900000000000000e+05 * (T[i] ** (1.94)) * np.exp(-1.748000000000000e+03 / (Rc * T[i]))
            kfh=1.200000000000000e+06 * (T[i] ** (1.87)) * np.exp(-1.902000000000000e+03 / (Rc * T[i]))
            logPl=1.032211564717057e+01
            logPh=1.083294127093656e+01
        elif P[i] < 1.013250000000001e+05:
            kfl=1.200000000000000e+06 * (T[i] ** (1.87)) * np.exp(-1.902000000000000e+03 / (Rc * T[i]))
            kfh=2.900000000000000e+06 * (T[i] ** (1.76)) * np.exp(-2.163000000000000e+03 / (Rc * T[i]))
            logPl=1.083294127093656e+01
            logPh=1.152608845149651e+01
        elif P[i] < 3.039750000000000e+05:
            kfl=2.900000000000000e+06 * (T[i] ** (1.76)) * np.exp(-2.163000000000000e+03 / (Rc * T[i]))
            kfh=1.900000000000000e+07 * (T[i] ** (1.54)) * np.exp(-2.727000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.262470074016462e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=1.900000000000000e+07 * (T[i] ** (1.54)) * np.exp(-2.727000000000000e+03 / (Rc * T[i]))
            kfh=2.600000000000000e+08 * (T[i] ** (1.22)) * np.exp(-3.593000000000000e+03 / (Rc * T[i]))
            logPl=1.262470074016462e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.039749999999998e+06:
            kfl=2.600000000000000e+08 * (T[i] ** (1.22)) * np.exp(-3.593000000000000e+03 / (Rc * T[i]))
            kfh=4.100000000000000e+09 * (T[i] ** (0.89)) * np.exp(-4.623999999999999e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.492728583315866e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=4.100000000000000e+09 * (T[i] ** (0.89)) * np.exp(-4.623999999999999e+03 / (Rc * T[i]))
            kfh=7.100000000000000e+10 * (T[i] ** (0.56)) * np.exp(-5.985000000000000e+03 / (Rc * T[i]))
            logPl=1.492728583315866e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.039750000000001e+07:
            kfl=7.100000000000000e+10 * (T[i] ** (0.56)) * np.exp(-5.985000000000000e+03 / (Rc * T[i]))
            kfh=3.900000000000000e+11 * (T[i] ** (0.38)) * np.exp(-7.329000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.722987092615271e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=3.900000000000000e+11 * (T[i] ** (0.38)) * np.exp(-7.329000000000000e+03 / (Rc * T[i]))
            kfh=2.600000000000000e+11 * (T[i] ** (0.48)) * np.exp(-8.655000000000000e+03 / (Rc * T[i]))
            logPl=1.722987092615271e+01
            logPh=1.843384373047865e+01
        else:
            kfl=2.600000000000000e+11 * (T[i] ** (0.48)) * np.exp(-8.655000000000000e+03 / (Rc * T[i]))
            kfh=2.600000000000000e+11 * (T[i] ** (0.48)) * np.exp(-8.655000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000001e+05:
            kfl=1.300000000000000e+29 * (T[i] ** (-6.03)) * np.exp(-2.989400000000000e+04 / (Rc * T[i]))
            kfh=1.300000000000000e+29 * (T[i] ** (-6.03)) * np.exp(-2.989400000000000e+04 / (Rc * T[i]))
            logPl=1.0e0
            logPh=1.152608845149651e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=6.000000000000000e+31 * (T[i] ** (-6.46)) * np.exp(-3.211000000000000e+04 / (Rc * T[i]))
            kfh=3.500000000000000e+29 * (T[i] ** (-5.46)) * np.exp(-3.254700000000000e+04 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        else:
            kfl=3.500000000000000e+29 * (T[i] ** (-5.46)) * np.exp(-3.254700000000000e+04 / (Rc * T[i]))
            kfh=3.500000000000000e+29 * (T[i] ** (-5.46)) * np.exp(-3.254700000000000e+04 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000001e+05:
            kfl=2.100000000000000e+17 * (T[i] ** (-1.68)) * np.exp(-3.180000000000000e+02 / (Rc * T[i])) + 1.200000000000000e+06 * (T[i] ** (2.0)) * np.exp(1.192000000000000e+03 / (Rc * T[i]))
            kfh=2.100000000000000e+17 * (T[i] ** (-1.68)) * np.exp(-3.180000000000000e+02 / (Rc * T[i])) + 1.200000000000000e+06 * (T[i] ** (2.0)) * np.exp(1.192000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=1.152608845149651e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=1.500000000000000e+19 * (T[i] ** (-2.18)) * np.exp(-2.166000000000000e+03 / (Rc * T[i])) + 1.200000000000000e+06 * (T[i] ** (2.0)) * np.exp(1.192000000000000e+03 / (Rc * T[i]))
            kfh=9.500000000000001e+21 * (T[i] ** (-2.91)) * np.exp(-5.633000000000000e+03 / (Rc * T[i])) + 1.200000000000000e+06 * (T[i] ** (2.0)) * np.exp(1.192000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.613125863748460e+01
        else:
            kfl=9.500000000000001e+21 * (T[i] ** (-2.91)) * np.exp(-5.633000000000000e+03 / (Rc * T[i])) + 1.200000000000000e+06 * (T[i] ** (2.0)) * np.exp(1.192000000000000e+03 / (Rc * T[i]))
            kfh=9.500000000000001e+21 * (T[i] ** (-2.91)) * np.exp(-5.633000000000000e+03 / (Rc * T[i])) + 1.200000000000000e+06 * (T[i] ** (2.0)) * np.exp(1.192000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
    ...
    for i in range(veclen):
        if P[i] < 1.013250000000000e+04:
            kfl=5.820000000000000e+10 * (T[i] ** (0.4)) * np.exp(-3.762000000000000e+03 / (Rc * T[i]))
            kfh=5.820000000000000e+10 * (T[i] ** (0.4)) * np.exp(-3.762000000000000e+03 / (Rc * T[i]))
            logPl=1.0e0
            logPh=9.223503358502464e+00
        elif P[i] < 3.201869999999998e+05:
            kfl=5.850000000000000e+10 * (T[i] ** (0.4)) * np.exp(-3.763000000000000e+03 / (Rc * T[i]))
            kfh=5.920000000000000e+10 * (T[i] ** (0.4)) * np.exp(-3.764000000000000e+03 / (Rc * T[i]))
            logPl=1.152608845149651e+01
            logPh=1.267666047909533e+01
        elif P[i] < 1.013250000000000e+06:
            kfl=5.920000000000000e+10 * (T[i] ** (0.4)) * np.exp(-3.764000000000000e+03 / (Rc * T[i]))
            kfh=6.300000000000000e+10 * (T[i] ** (0.39)) * np.exp(-3.782000000000000e+03 / (Rc * T[i]))
            logPl=1.267666047909533e+01
            logPh=1.382867354449055e+01
        elif P[i] < 3.201870000000002e+06:
            kfl=6.300000000000000e+10 * (T[i] ** (0.39)) * np.exp(-3.782000000000000e+03 / (Rc * T[i]))
            kfh=9.530000000000000e+10 * (T[i] ** (0.34)) * np.exp(-3.931000000000000e+03 / (Rc * T[i]))
            logPl=1.382867354449055e+01
            logPh=1.497924557208938e+01
        elif P[i] < 1.013249999999999e+07:
            kfl=9.530000000000000e+10 * (T[i] ** (0.34)) * np.exp(-3.931000000000000e+03 / (Rc * T[i]))
            kfh=2.600000000000000e+11 * (T[i] ** (0.23)) * np.exp(-4.413000000000000e+03 / (Rc * T[i]))
            logPl=1.497924557208938e+01
            logPh=1.613125863748460e+01
        elif P[i] < 3.201870000000000e+07:
            kfl=2.600000000000000e+11 * (T[i] ** (0.23)) * np.exp(-4.413000000000000e+03 / (Rc * T[i]))
            kfh=3.830000000000000e+11 * (T[i] ** (0.2)) * np.exp(-5.099000000000000e+03 / (Rc * T[i]))
            logPl=1.613125863748460e+01
            logPh=1.728183066508342e+01
        elif P[i] < 1.013249999999999e+08:
            kfl=3.830000000000000e+11 * (T[i] ** (0.2)) * np.exp(-5.099000000000000e+03 / (Rc * T[i]))
            kfh=4.180000000000000e+10 * (T[i] ** (0.51)) * np.exp(-5.532000000000000e+03 / (Rc * T[i]))
            logPl=1.728183066508342e+01
            logPh=1.843384373047865e+01
        else:
            kfl=4.180000000000000e+10 * (T[i] ** (0.51)) * np.exp(-5.532000000000000e+03 / (Rc * T[i]))
            kfh=4.180000000000000e+10 * (T[i] ** (0.51)) * np.exp(-5.532000000000000e+03 / (Rc * T[i]))
            logPl=1.843384373047865e+01
            logPh=100.0e0
        kf[i] = np.exp(np.log(kfl) + (np.log(kfh)-np.log(kfl))*(np.log(P[i])-logPl)/(logPh-logPl))
